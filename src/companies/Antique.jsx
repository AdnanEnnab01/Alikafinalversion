  ...
  return (
    <>
      ...
      >
        {videoFullscreen && (
          <video
            key={`antique-video-${videoFullscreen}`}
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                fontSize: '16px',
                fontWeight: '700',
                color: activeTab === 'tab1' ? '#ffffff' : '#f3c06b',
                background: activeTab === 'tab1' ? '#f3c06b' : 'rgba(255, 255, 255, 0.9)',
            ...
            <button
              ...
              style={{
                ...
                fontSize: '16px',
                fontWeight: '700',
                color: activeTab === 'tab2' ? '#ffffff' : '#f3c06b',
                background: activeTab === 'tab2' ? '#f3c06b' : 'rgba(255, 255, 255, 0.9)',
                border: '2px solid #f3c06b',
                borderRadius: '8px',
                cursor: 'pointer',
                transition: 'all 0.3s ease',
            ...
            <button
              ...
              style={{
                ...
                fontSize: '16px',
                fontWeight: '700',
                color: activeTab === 'tab3' ? '#ffffff' : '#f3c06b',
                background: activeTab === 'tab3' ? '#f3c06b' : 'rgba(255, 255, 255, 0.9)',
                border: '2px solid #f3c06b',
                borderRadius: '8px',
                cursor: 'pointer',
                transition: 'all 0.3s ease',
            ...
            <button
              ...
              style={{
                ...
                fontSize: '16px',
                fontWeight: '700',
                color: activeTab === 'tab4' ? '#ffffff' : '#f3c06b',
                background: activeTab === 'tab4' ? '#f3c06b' : 'rgba(255, 255, 255, 0.9)',
                border: '2px solid #f3c06b',
                borderRadius: '8px',
                cursor: 'pointer',
                transition: 'all 0.3s ease',
